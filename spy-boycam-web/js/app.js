...
$(document).ready(function () {
    ...
    window.addEventListener('message', function (event) {
        ...
        if (data.action === 'open') {
            ...
            $('.overlayCont').removeClass('fadeOut').addClass('fadeIn').css({
            ...
            $('.overlayCont').removeClass('fadeIn').addClass('fadeOut').css({
                'animation-duration': '0.5s'
            });
            
            // After animation, hide
            setTimeout(function() {
                $('.overlayCont').hide().removeClass('fadeOut');
            }, 500);
        ...
        if (data.action === 'toggle_record') {
            ...
            if (!isRecording) {
                // Start recording
                isRecording = true;
                $('.HeadText').html('<i class="fa-solid fa-circle fa-fade bodyIcon" style="color: rgb(173, 8, 8);"></i>' + 'Record Started');
                $('.RecordInfo').fadeIn();
                ...
                recordingTimeout = setTimeout(() => {
                    if (isRecording) {
                        ...
                        isRecording = false;
                        $('.HeadText').html('<i class="fa-solid fa-circle bodyIcon" style="color: white;"></i>' + 'Record Stopped');
                        setTimeout(() => {
                            $('.RecordInfo').fadeOut();
                        }, 2000);
                        stopRecording();
